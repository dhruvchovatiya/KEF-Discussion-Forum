    ...
    <nav className="bg-blue-900 shadow dark:bg-gray-800">
        ...
        <div className="lg:flex lg:items-center">
          <div className="flex items-center justify-between">
            {/* <div className=" border-black border-double">
              <a className="" href="#"><img src={logo} className="object-contain w-10 h-10 p-0"/></a>
            </div> */}
            {/* Mobile menu button */}
          ...
          <div className="flex flex-col text-white capitalize dark:text-gray-300 lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">
            ...
            <Link to="/analytics" className="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-400 dark:hover:text-gray-200">Analytics</Link>
            <Link to="/about" className="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-400 dark:hover:text-gray-200">About us</Link>
            {/* <Link to="#" className="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-400 dark:hover:text-gray-200">docs</Link>
            <Link to="#" className="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-400 dark:hover:text-gray-200">support</Link>
            <Link to="#" className="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-400 dark:hover:text-gray-200">blog</Link> */}
      ...
      <a href="#" className="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300" aria-label="Github">
        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col text-white capitalize dark:text-gray-300 lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">
            <Link to='/login' className="mt-2 lg:mt-0 lg:mx-4 hover:text-white hover:bg-red-700 dark:hover:text-gray-200 bg-red-600 px-4 py-2 rounded-md">Log In</Link>
            <Link to='/signup' className="mt-2 lg:mt-0 lg:mx-4 hover:text-white hover:bg-red-700 dark:hover:text-gray-200 bg-red-600 px-4 py-2 rounded-md">Sign Up</Link>
